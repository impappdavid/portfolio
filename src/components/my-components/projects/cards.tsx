    ...
    return (
        <>
            {projectsData.map((card, index) => (
                <Link key={index} href={card.link} className="w-full bg-zinc-800/30 border border-zinc-800/30 rounded-2xl overflow-hidden hover:cursor-pointer">
                    ...
                    <div className="py-4 px-6 flex justify-between items-center gap-4">
                        ...
                        <div className="">
                            <div className="py-1 px-2 bg-transparent border border-neutral-800 rounded-lg text-xs font-body">{card.tag}</div>
                        </div>
                    </div>
                </Link>
            ))}
