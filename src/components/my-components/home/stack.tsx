            ...
            <div className="flex flex-col gap-6 items-start w-full">
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="flex flex-col gap-2 w-full ">
                            <div className={`text-start text-sm text-zinc-400 ${kodemonoFont.className}`}>Languages</div>
                            <div className="grid sm:grid-cols-4">
                                ...
                                <div className="flex p-2 gap-2 border-y border-r items-center justify-center hover:bg-zinc-200 aspect-square transition-all">
                                    <div className="p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                                            <g fill="none">
                                                <g fill="#27272a" clip-path="url(#SVGXv8lpc2Y)">
                                ...
                                <div className="flex p-2 gap-2 border-y border-r items-center justify-center hover:bg-zinc-200 aspect-square transition-all">
                                    <div className="p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                                            <path fill="#27272a" d="M7.502 0h2.578v1.078h-1.5v1.078h1.5v1.078H7.502zm3.093 0h2.579v.938h-1.5v.187h1.5v2.156h-2.579v-.984h1.5v-.188h-1.5zm3.095 0h2.577v.938h-1.5v.187h1.5v2.156H13.69v-.984h1.5v-.188h-1.5z" />
                                            <path fill="#27272a" fill-rule="evenodd" d="m11.991 24l-6.944-1.928L3 4.717h18L18.954 22.07zM7.047 12.573l.191 2.128h7.377l-.247 2.76l-2.374.642h-.002l-2.37-.64l-.152-1.697H7.333l.298 3.342l4.36 1.21l4.367-1.21l.532-5.964l.052-.571l.384-4.309H6.664l.194 2.129h8.136l-.194 2.18z" clip-rule="evenodd" />
                                        </svg>
                                    </div>
                                </div>
                        ...
                        <div className="grid sm:grid-cols-4">
                            ...
                            <div className="flex p-2 gap-2 border items-center justify-center hover:bg-zinc-200 aspect-square transition-all">
                                <div className="p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                                        <path fill="#27272a" fill-rule="evenodd" d="M7 9.969q1-4.063 5-4.063c4 0 4.5 3.047 6.5 3.555q2 .508 3.5-1.524Q21 12 17 12c-4 0-4.5-3.047-6.5-3.555Q8.5 7.938 7 9.97m-5 6.094Q3 12 7 12c4 0 4.5 3.047 6.5 3.555q2 .507 3.5-1.524q-1 4.063-5 4.063c-4 0-4.5-3.047-6.5-3.555q-2-.508-3.5 1.524" clip-rule="evenodd" />
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div className={`text-start text-sm text-zinc-400 ${kodemonoFont.className}`}>Backend</div>
                        ...
                        <div className="grid sm:grid-cols-3">
                            ...
                            <div className="flex p-2 gap-2 border items-center justify-center hover:bg-zinc-200 aspect-square transition-all">
                                <div className="p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                                        <path fill="#27272a" d="M7 7H5a2 2 0 0 0-2 2v8h2v-4h2v4h2V9a2 2 0 0 0-2-2m0 4H5V9h2m7-2h-4v10h2v-4h2a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2m0 4h-2V9h2m6 0v6h1v2h-4v-2h1V9h-1V7h4v2Z" />
                                    </svg>
                                </div>
                            </div>
                        </div>

                        <div className={`text-start text-sm text-zinc-400 ${kodemonoFont.className}`}>Databases</div>
                        ...
                        <div className="grid sm:grid-cols-4">
                            ...
                            <div className="flex p-2 gap-2 border items-center justify-center hover:bg-zinc-200 aspect-square transition-all">
                                <div className="p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                                        <g fill="none" stroke="#27272a" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
