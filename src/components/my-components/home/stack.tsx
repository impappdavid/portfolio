                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                            <div className="flex flex-col justify-center items-center p-4 py-6 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-sky-500 to-sky-600 rounded-2xl">
                                ...
                                <div className="font-semibold text-zinc-700">React</div>
                            </div>

                            <div className="flex flex-col justify-center items-center p-4  gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-blue-500 to-blue-600 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="text-white">
                                ...
                                <div className="font-semibold text-zinc-700">TypeScript</div>
                            </div>
                            <div className="flex flex-col justify-center items-center p-4 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-yellow-500 to-yellow-600 rounded-2xl ">
                                ...
                                <div className="font-semibold text-zinc-700">JavaScript</div>
                            </div>
                            <div className="flex flex-col justify-center items-center p-4 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-sky-500 to-sky-600 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="text-white">
                                ...
                                <div className="font-semibold text-zinc-700">TailwindCSS</div>
                            </div>
                            <div className="flex flex-col justify-center items-center p-4 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 32 32" >
                                        <path stroke="#dedede" stroke-linecap="round" stroke-width="4.48" d="m27.76 16.56l-11.2 11.2m8.96-23.52L4.24 25.52" />
                                    </svg>
                                </div>
                                <div className="font-semibold text-zinc-700">shadcn/ui</div>
                            </div>

                            <div className="flex flex-col justify-center items-center p-4 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-orange-600 to-red-600 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="text-white">
                                ...
                                <div className="font-semibold text-zinc-700">React Query</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                            <div className="flex flex-col justify-center items-center p-4 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                ...
                                <div className="font-semibold text-zinc-700">GitHub</div>
                            </div>

                            <div className="flex flex-col justify-center items-center p-4 gap-2 bg-zinc-200/60 rounded-3xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                <div className="p-2 sm:p-3 bg-gradient-to-b from-orange-500 to-orange-600 rounded-2xl hover:scale-105 transition-transform duration-300 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="fill-white">
                                        <path d="M2.6 10.59L8.38 4.8l1.69 1.7c-.24.85.15 1.78.93 2.23v5.54c-.6.34-1 .99-1 1.73a2 2 0 0 0 2 2a2 2 0 0 0 2-2c0-.74-.4-1.39-1-1.73V9.41l2.07 2.09c-.07.15-.07.32-.07.5a2 2 0 0 0 2 2a2 2 0 0 0 2-2a2 2 0 0 0-2-2c-.18 0-.35 0-.5.07L13.93 7.5a1.98 1.98 0 0 0-1.15-2.34c-.43-.16-.88-.2-1.28-.09L9.8 3.38l.79-.78c.78-.79 2.04-.79 2.82 0l7.99 7.99c.79.78.79 2.04 0 2.82l-7.99 7.99c-.78.79-2.04.79-2.82 0L2.6 13.41c-.79-.78-.79-2.04 0-2.82" />
                                    </svg>
                                </div>
                                <div className="font-semibold text-zinc-700">Git</div>
                            </div>
                        </div>
                    </div>
