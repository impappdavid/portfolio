                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="grid sm:grid-cols-2 gap-2">
                            ...
                            <div className="flex p-2 gap-2 border-t items-center">
                                <div className="p-2 bg-gradient-to-b from-sky-500 to-sky-600 rounded-2xl h-fit">
                                ...
                                <div className="flex flex-col text-start justify-center">
                                    ...
                                    <div className="text-zinc-500 text-sm">For building fast, interactive UIs.</div>
                                </div>
                            </div>

                            <div className="flex p-2 gap-2 border-t items-center">
                                <div className="p-2 bg-gradient-to-b from-blue-500 to-blue-600 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="text-white">
                                        <g fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5" >
                                            ...
                                            <path strokeLinecap="round" d="M18 12h-1.8a1.2 1.2 0 0 0-1.2 1.2v.6a1.2 1.2 0 0 0 1.2 1.2h.6a1.2 1.2 0 0 1 1.2 1.2v.6a1.2 1.2 0 0 1-1.2 1.2H15m-6.5-6h2m2 0h-2m0 0v6" />
                                        </g>
                                    </svg>
                                </div>
                                <div className="flex flex-col text-start justify-center">
                                    <div className="font-semibold text-zinc-700">TypeScript</div>
                                    <div className="text-zinc-500 text-sm">Typed JavaScript for safer code.</div>
                                </div>
                            </div>
                            <div className="flex p-2 gap-2 border-t items-center">
                                <div className="p-2  bg-gradient-to-b from-yellow-500 to-yellow-600 rounded-2xl ">
                                ...
                                <div className="flex flex-col text-start justify-center">
                                    ...
                                    <div className="text-zinc-500 text-sm">The web’s programming language.</div>
                                </div>

                                
                            </div>
                            <div className="flex p-2 gap-2 border-t items-center">
                                <div className="p-2  bg-gradient-to-b from-sky-500 to-sky-600 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="text-white">
                                ...
                                <div className="flex flex-col text-start justify-center">
                                    ...
                                    <div className="text-zinc-500 text-sm"> Utility-first CSS for rapid UI styling.</div>
                                </div>

                               
                            </div>
                            <div className="flex p-2 gap-2 border-t items-center">
                                <div className="p-2 bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-2xl ">
                                ...
                                <div className="flex flex-col text-start justify-center">
                                    ...
                                    <div className="text-zinc-500 text-sm">React components, Tailwind + Radix.</div>
                                </div>
                            </div>

                            <div className="flex p-2 gap-2 border-t items-center">
                                <div className="p-2 bg-gradient-to-b from-orange-600 to-red-600 rounded-2xl ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" className="text-white">
                                ...
                                <div className="flex flex-col text-start justify-center">
                                    ...
                                    <div className="text-zinc-500 text-sm">Server-state caching and sync for React.</div>
                                </div>
                    ...
                    <div className="flex flex-col gap-2 w-full ">
                        ...
                        <div className="grid sm:grid-cols-2 gap-2">
                            ...
                            <div className="flex p-2 gap-2 border-t items-center">
                                ...
                                <div className="flex flex-col text-start justify-center">
                                    <div className="font-semibold text-zinc-700">Git & GitHub</div>
                                    <div className="text-zinc-500 text-sm">Version control and collaboration</div>
                                </div>
                            </div>
