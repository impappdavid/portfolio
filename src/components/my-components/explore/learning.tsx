            ...
            <div className="w-full border  rounded-2xl flex flex-col gap-4">
                <div className="p-8 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2">
                        <div className="p-2 flex gap-2 hover:bg-zinc-800/20 border border-transparent hover:border-zinc-800 rounded-lg transition-all duration-500 cursor-pointer">
                            ...
                            <div className="flex flex-col justify-center">
                                <div className="text-white text-sm font-body font-semibold">Docker</div>
                        ...
                        <div className="p-2 flex gap-2 hover:bg-zinc-800/20 border border-transparent hover:border-zinc-800 rounded-lg transition-all duration-500 cursor-pointer">
                            ...
                            <div className="flex flex-col justify-center">
                                <div className="text-white text-sm font-body font-semibold">Express.js</div>
                                <div className="text-xs font-body text-zinc-400 max-w-80 truncate ">Express.js helps you build web servers with Node.js, fast and simple.</div>
                            </div>
