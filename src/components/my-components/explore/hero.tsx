        ...
        <div className="flex flex-col items-start w-full py-24 gap-8">
            <div className="flex flex-col gap-6 animate-[downblur_2s_ease-in-out]">
                ...
                <div className="flex gap-4 font-body">
                    ...
                    <Link href="../contact" className="w-fit py-1.5 px-4 text-sm rounded-lg bg-zinc-900 text-white font-body hover:opacity-70 hover:bg-zinc-900 border flex items-center gap-1  border-zinc-800 transition-all duration-500">
                        Contact
            ...
            <div className="flex flex-col gap-6 animate-[downblur_2.5s_ease-in-out] w-full">
