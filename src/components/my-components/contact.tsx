                ...
                <div className="w-full flex flex-col gap-3 justify-center text-xs text-zinc-600 dark:text-zinc-400 ">
                    ...
                    <div className="w-full flex justify-center">
                        <a href="https://x.com/Dvid50334776" target="__blank"
                            className="bg-black dark:bg-white p-1 px-3 w-fit rounded-sm flex gap-1 items-center text-lg hover:text-white text-zinc-300 dark:hover:text-black transition-all dark:text-zinc-600">
