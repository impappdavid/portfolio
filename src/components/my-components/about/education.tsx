                ...
                <div className="p-8 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2">
                        ...
                        {petrik.map((stack, index) => (
                            <div key={index} className="p-2 flex gap-2 hover:bg-zinc-800/20 border border-transparent hover:border-zinc-800 rounded-lg transition-all duration-500 cursor-pointer group">
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <div className="text-xs font-body text-zinc-400 max-w-80 truncate">{stack.description}</div>
                                </div>
