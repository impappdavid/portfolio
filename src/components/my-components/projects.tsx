...
export default function Projects() {
    let projects = [
        {
            name: "Azura",
            description: "Azura is an AI-powered marketplace for creating and trading unique NFTs.",
            stack: [
                {
            ...
            github: "",
            src: "/projects/azura/cover.png",
            journey: "/projects/frontend/azura",
            live: "",
        },
        {
            name: "Cinema View",
                    ...
                    {projects.map((project, index) => (
                        <Link href={project.journey} className="block">
                            <div className="w-full bg-zinc-100 dark:bg-zinc-900  rounded-xl hover:cursor-pointer hover:border-zinc-300 dark:hover:border-zinc-700 transition-all relative group">
                                <img src={project.src} alt={project.name} className="w-full aspect-auto sm:h-72 rounded-xl bg-contain	" />
