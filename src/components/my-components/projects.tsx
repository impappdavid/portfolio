                    ...
                    <div className="w-full bg-zinc-100 dark:bg-zinc-900 border p-0.5 rounded-xl hover:cursor-pointer hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
                        ...
                        <div className="p-1 flex flex-col gap-2">
                            ...
                            <div className="flex gap-2">
                                <Button className="px-2 bg-zinc-100 dark:bg-zinc-950 text-xs font-sans text-black dark:text-white flex gap-1 border hover:bg-zinc-200/50 dark:hover:bg-zinc-950/50 dark:hover:border-zinc-700 hover:border-zinc-300 rounded-lg" asChild>
                                    <Link href="https://github.com/impappdavid/portfolio" target="__blank">
