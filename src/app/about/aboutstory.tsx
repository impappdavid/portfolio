  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="space-y-2 border-b border-zinc-200 dark:border-zinc-800 pb-4">
          <div className="flex items-center justify-between text-xs">
            <span className="text-zinc-500 dark:text-zinc-400 tracking-widest uppercase flex items-center gap-2">
              &gt; PERSONAL_ARCHIVE
            </span>
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight pt-1">
        ...
        <motion.div variants={itemVariants} className="space-y-3">
          <span className="text-xs text-zinc-500 dark:text-zinc-400 tracking-widest uppercase block font-semibold">
        ...
        <motion.div variants={itemVariants} className="space-y-3">
          ...
          <p>
            Deciding to take development seriously, I enrolled in an intensive 1-year Software Developer &amp; Tester program. Right on day one, they announced an opportunity for selected students to join a dual-training program directly inside an actual IT company: <strong className="text-zinc-900 dark:text-zinc-100">Webváltó Kft.</strong>
          </p>
          <p className="text-zinc-600 dark:text-zinc-400">
      ...
      <motion.footer
        ...
        className="pt-8 mt-12 border-t border-zinc-200 dark:border-zinc-800 flex flex-wrap justify-between items-center text-xs text-zinc-500 font-mono gap-4 select-none shrink-0"
      >
        <span className="text-zinc-500 dark:text-zinc-400 lg:flex hidden">&gt; CONNECT</span>
