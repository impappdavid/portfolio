...
export default function AboutStory() {
  ...
  return (
    ...
    >
      ...
      {/* Social Links Footer */}
      <footer className="pt-8 mt-12 border-t border-zinc-800 flex flex-wrap justify-between items-center text-xs text-zinc-500 font-mono gap-4 select-none shrink-0">
